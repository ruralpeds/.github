<script lang="ts">
	...
	function simUrl(id: string): string {
		return `${base}/simulations/${id}_simulation.html`;
	}
</script>
...
<div class="page">
	...
	<div class="stats-row">
		<div class="stat"><span class="stat-val">19</span><span class="stat-label">Scenarios</span></div>
		<div class="stat"><span class="stat-val">3</span><span class="stat-label">Modules</span></div>
		<div class="stat"><span class="stat-val">35</span><span class="stat-label">Decision Points</span></div>
